...
const { createTweet, likeOrUnLike, updateTweet, bookUpdated, deleteTweet } = require('../controller/tweetController');
...
tweetRoutes.delete("/delete/:id", verifyToken, deleteTweet);
